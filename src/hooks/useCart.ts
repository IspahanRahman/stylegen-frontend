...
export function useCart() {
  ...
  const addToCart = useCallback((product: any, quantity: number = 1, selectedSize?: string) => {
  ...
  const updateQuantity = useCallback((productId: string, quantity: number, stock: number, size?: string) => {
    if (quantity > stock) {
